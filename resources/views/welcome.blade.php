        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        ...
                        <a href="{{ url('/home') }}" class="mx-3 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">status</a>
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <div class="flex justify-center ">
                   <img class="animated infinite jello" src="../img/mixue.png" width="250px" height="250px" alt="">
                </div>
                
                <div class="">
                    <center>
                    <h1 class="display-5 mb-4" style="color: #75C2F6; font-family: 'Kids Donuts', sans-serif;">WELCOME TO ICE CREAMM!</h1>
                    </center>
                </div>
        ...
        <div class="container">
            <div class="row g-4 align-items-end mb-4">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <img class="animated infinite tada" src="img/child.png">
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h1 class="display-5 mb-4" style="color: #FF9B9B;">I Like Ice Creamm!!</h1>
                    <p class="mb-4">
                        let's find the taste in every bite, tell others how happy
                         you are every time you feel a different taste in your choice of ice cream
                    </p>
                </div>
            </div>
        </div>
    </div>
        <audio controls  class="col-3">
            <source src="music/eskrimmm.mp3" type="audio/ogg">
            Your browser does not support the audio element.
          </audio>
    <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" id="home">
        <img src="img/cloud.jpg" height="100%" width="100%" alt="">
      </div>
